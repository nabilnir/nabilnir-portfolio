  ...
  return (
    <main className="w-full min-h-screen flex flex-col items-center py-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-20 text-center">
        ...
        }} className="inline-flex items-center justify-center px-8 py-4 text-base font-medium text-white bg-primary rounded-full hover:bg-gray-800 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1">
          Download Resume
